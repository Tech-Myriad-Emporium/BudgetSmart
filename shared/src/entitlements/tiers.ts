...
export const TIERS: Tier[] = [
  ...
  },
  {
    ...
    name: "Tier 1",
    group: "individual",
    priceCents: toCents(4.99),
    interval: "month",
    memberLimit: 1,
    level: 1,
    tagline: "Basic automation — set it and forget it.",
    highlights: [
  ...
  },
  {
    ...
    name: "Tier 2",
    group: "individual",
    priceCents: toCents(8.99),
    interval: "month",
    memberLimit: 1,
    level: 2,
    tagline: "Advanced insight — investments, net worth & AI.",
    highlight: true,
    highlights: [
  ...
  },
  {
    ...
    memberLimit: 1,
    level: 3,
    tagline: "The full suite — pro tools, tax intelligence & AI.",
    highlights: [
