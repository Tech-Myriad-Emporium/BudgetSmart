...
const M: Record<string, Partial<Record<Locale, string>>> = {
  ...
  "dl.sub": { en: "Windows, macOS, Linux, and Android are available now — iOS is on the way.", es: "Windows, macOS, Linux y Android ya disponibles — iOS en camino.", fr: "Windows, macOS, Linux et Android sont disponibles — iOS arrive.", de: "Windows, macOS, Linux und Android sind da — iOS folgt.", pt: "Windows, macOS, Linux e Android já disponíveis — iOS a caminho.", zh: "Windows、macOS、Linux 和 Android 现已上线 — iOS 即将推出。", ja: "Windows・macOS・Linux・Androidは提供中 — iOSは近日公開。", hi: "Windows, macOS, Linux और Android अभी उपलब्ध — iOS जल्द।", ar: "Windows وmacOS وLinux وAndroid متاحة الآن — iOS قريبًا." },
